...
CREATE TABLE "bills" (
	...
	"group_id" uuid NOT NULL,
	"name" text NOT NULL,
	"type" "bill_type" DEFAULT 'subscription' NOT NULL,
	"currency" char(3) NOT NULL,
...
ALTER TABLE "bills" ADD CONSTRAINT "bills_default_account_id_accounts_id_fk" FOREIGN KEY ("default_account_id") REFERENCES "public"."accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "bill_default_line_tags_tag_idx" ON "bill_default_line_tags" USING btree ("tag_id");--> statement-breakpoint
CREATE INDEX "bill_default_lines_bill_idx" ON "bill_default_lines" USING btree ("bill_id");--> statement-breakpoint
CREATE INDEX "bill_default_lines_category_idx" ON "bill_default_lines" USING btree ("category_id");--> statement-breakpoint
