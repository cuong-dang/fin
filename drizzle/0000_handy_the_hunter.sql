...
CREATE UNIQUE INDEX "accounts_group_recurring_plan_unique" ON "accounts" USING btree ("recurring_plan_id") WHERE "accounts"."deleted_at" IS NULL;--> statement-breakpoint
